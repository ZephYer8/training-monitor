...
```bash
python3 -m pip install --user --upgrade "https://gh-proxy.com/https://github.com/ZephYer8/training-monitor/releases/download/v0.7.24/xunji_training_monitor-0.7.24-py3-none-any.whl"
...
```bash
python3 -m pip install --user --upgrade "https://gh.llkk.cc/https://github.com/ZephYer8/training-monitor/releases/download/v0.7.24/xunji_training_monitor-0.7.24-py3-none-any.whl"
```
